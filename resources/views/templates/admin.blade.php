        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('assetsView') }}">
                            <i class="ni ni-laptop text-primary"></i>
                            <span class="nav-link-text">Assets</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('assignAssetsView') }}">
                            <i class="ni ni-collection text-primary"></i>
                            <span class="nav-link-text">Assign Assets</span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('settingsView') }}">
